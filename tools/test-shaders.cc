...
//
// Compile:
//   g++ -std=c++20 -O2 -Isrc -Isrc/vendor/reshade \
//       tools/test-shaders.cc \
//       -Lbuild/reorg/src/vendor/reshade -lreshade \
...
#include "reshade/effect_preprocessor.hh"
#include "reshade/effect_parser.hh"
#include "reshade/effect_codegen.hh"
#include "reshade/effect_module.hh"

namespace fs = std::filesystem;

// --- Signal-safe crash recovery (mirrors reshade_parser.cc) ---
...
// --- Preprocessor setup (mirrors addStandardMacros from reshade_parser.cc) ---
